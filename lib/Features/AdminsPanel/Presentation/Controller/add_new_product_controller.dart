...
import 'package:ecommerce_store/Core/HelpingFunctions/image_picker.dart';
    ...
    if (key.currentState!.validate()) {
      if (selectedColors.isEmpty || sizes.isEmpty || imageFiles.isEmpty) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(" Either colors,Sizes or Images are not selected"),
          ),
        );
      } else {
        context.read<ProductsBloc>().add(
          AddProductsEvent(
            ...
            product: Product(
              ...
              colors:
                  selectedColors
                      .map((e) => ColorFormats.getColorString(e))
                      .toList(),
