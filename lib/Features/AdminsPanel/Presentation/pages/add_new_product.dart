...
import 'package:ecommerce_store/Core/constants/sizes.dart';
        ...
        child: SingleChildScrollView(
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Fill the following fields to add your new product. Fields marked with \' * \' are must to be filled',
                          ...
                          showDialog(
                            ...
                            builder:
                                (_) => AlertDialog(
                                  ...
                                  content: const Text('Add Products new size'),
                                  actions: [
                                    InputField(
                                    ...
                                    TextButton(
                                      onPressed: () {
                                        if (controller.size.text
                                            .trim()
                                            .isNotEmpty) {
                                          if (!controller.sizes.contains(
                                            controller.size.text.trim(),
                                          )) {
                                            controller.sizes.add(
                                              controller.size.text.trim(),
                                            );
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: Image.file(
                                ...
                                height:
                                    TDeviceUtils.getScreenHeight(context) / 4,
                                fit: BoxFit.cover,
                              ),
                            ),
                            Positioned(
