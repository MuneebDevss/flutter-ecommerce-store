...
class ProductRepository {
  ...
  Future<Either<String, List<Product>>> retrieveByBrand(
    String brandName,
  ) async {
    try {
  ...
  Future<Either<String, List<Product>>> retrieveCategory(
    String category,
  ) async {
    try {
  ...
  Future<Either<String, String>> uploadProduct(
    Product product,
    List<File> images,
  ) async {
    try {
