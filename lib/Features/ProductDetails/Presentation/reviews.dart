import 'package:ecommerce_store/Core/Widgets/my_list_tile.dart';
import 'package:ecommerce_store/Core/Widgets/my_rectangular_image.dart';
import 'package:ecommerce_store/Core/constants/color_palette.dart';
import 'package:ecommerce_store/Features/ProductDetails/Presentation/Controllers/review_controller.dart';
import 'package:ecommerce_store/Features/ProductDetails/Presentation/ProductsBloc/make_review.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            AnalyticsContainer(entity: controller),
            const SizedBox(height: Sizes.spaceBtwItems),
            const SizedBox(height: Sizes.spaceBtwSections),
            Center(
              child: RatingBar(
                ratingWidget: RatingWidget(
                  full: const Icon(Iconsax.star1, color: Colors.yellow),
                  half: const Icon(Iconsax.star, color: Colors.yellow),
                  empty: const Icon(Iconsax.star, color: Colors.yellow),
                ),
                ...
                itemBuilder: (_, index) {
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: Sizes.spaceBtwItems / 2),
                      MyReadMoreText(text: comment.comment),
                      const SizedBox(height: Sizes.spaceBtwItems / 2),
...
class MyReadMoreText extends StatelessWidget {
  const MyReadMoreText({super.key, required this.text});
  final String text;
  @override
  Widget build(BuildContext context) {
    return ReadMoreText(
...
class AnalyticsContainer extends StatelessWidget {
  const AnalyticsContainer({super.key, required this.entity});
        ...
        Expanded(
          ...
          child: Column(
            children: [
              ...
              RatingBarIndicator(
                itemBuilder: (_, index) {
                  return const Icon(Iconsax.star1, color: Colors.yellow);
                },
                itemCount: 5,
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: LinearProgressIndicator(
                      value:
                          entity.reviewList[index] == 0
                              ? 0
                              : entity.getPercentage(index),
                      minHeight: Sizes.sm,
