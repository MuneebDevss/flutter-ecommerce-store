...
import 'package:ecommerce_store/Features/ProductDetails/Presentation/product_details.dart';
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: Sizes.spaceBtwItems),
            InputField(
              label: 'Describe What you feel about our product',
              contentPadding: 25,
              controller: comments,
            ),
          ],
