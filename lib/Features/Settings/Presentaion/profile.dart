...
import 'package:ecommerce_store/Features/Auth/Presentation/login_page.dart';
import 'package:ecommerce_store/Features/Settings/Presentaion/Controllers/profile_controller.dart';
                ...
                children: [
                  ...
                  if (controller.user.profilePicture.isNotEmpty)
                    BlocListener<SettingsBloc, SettingState>(
                      ...
                      child:
                          controller.user.profilePicture.isEmpty
                              ? ClipRRect(
                  ...
                  TextButton(
                    onPressed:
                        () async => await controller.addProfilePicture(context),
                    child: Text(
                      'Change Profile Picture',
                      style: Theme.of(
                        context,
                      ).textTheme.labelSmall!.apply(color: TColors.primary),
                    ),
                  ),
                  const SizedBox(height: Sizes.spaceBtwItems),
                  Divider(
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        SizedBox(
          width:
              TDeviceUtils.getScreenWidth(context) / 3 - Sizes.defaultSpace / 3,
