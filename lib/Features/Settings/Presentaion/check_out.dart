...
import 'package:ecommerce_store/Features/Settings/Presentaion/Controllers/address_Controller.dart';
import 'package:ecommerce_store/Features/Settings/Presentaion/Controllers/check_out_controller.dart';
import 'package:ecommerce_store/Features/Settings/Presentaion/address.dart';
import 'package:ecommerce_store/Features/Settings/Presentaion/my_orders.dart';
import 'package:ecommerce_store/Features/Settings/Presentaion/settingBloc/settings_bloc.dart';
import 'package:ecommerce_store/Features/Settings/domain/Entities/order_entity.dart';
                ...
                context.read<SettingsBloc>().add(
                  MakeOrdersEvent(
                    item: Orders(
                      ...
                      orderId: '',
                      products: controller.productIds(CartController.cartItems),
                    ),
                  ),
                );
              },
            ...
            children: [
              Wrap(
                ...
                children: List.generate(
                  ...
                  (index) => MyCartItem(item: CartController.cartItems[index]),
                ),
              ),
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SpacedText(
                        ...
                        secondStyle: Theme.of(context).textTheme.labelLarge!
                      ...
                      SpacedText(
                        ...
                        secondStyle: Theme.of(
                          context,
                        ).textTheme.labelMedium!.apply(color: TColors.primary),
                      ),
                      ...
                      BlocConsumer<SettingsBloc, SettingState>(
                        builder: (BuildContext context, state) {
                          ...
                          return AddressController.currentAddress == null
                              ? MyShippingAddress(
                                address:
                                    AddressController.currentAddress ??
                                    Address(
...
class MyShippingAddress extends StatelessWidget {
  const MyShippingAddress({super.key, required this.address});
          ...
          Row(
            ...
            children: [
              const CircularContainer(
                width: Sizes.iconMd,
                height: Sizes.iconMd,
                child: Icon(Icons.call, size: Sizes.iconSm),
              ),
              const SizedBox(width: Sizes.sm),
              Text(
                address.phoneNumber,
          ...
          Row(
            ...
            children: [
              const CircularContainer(
                width: Sizes.iconMd,
                height: Sizes.iconMd,
                child: Icon(Iconsax.location, size: Sizes.iconSm),
              ),
              const SizedBox(width: Sizes.sm),
              Text(
