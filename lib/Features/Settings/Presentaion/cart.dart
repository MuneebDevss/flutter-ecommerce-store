import 'package:ecommerce_store/Features/Settings/Presentaion/Controllers/cart_controller.dart';
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder:
            (_, index) => Column(
              children: [
                MyCartItem(item: CartController.cartItems[index]),
                const SizedBox(height: Sizes.spaceBtwItems),
                Row(
                  children: [
                    const SizedBox(width: Sizes.appBarHeight + 10 + Sizes.xs),
                    Expanded(
                      child: Row(
                        children: [
                          CircularContainer(
                              ...
                              onPressed: () {
                                ...
                                if (CartController.cartItems[index].quantity !=
                                  ...
                                  context.read<SettingsBloc>().add(
                                    DeleteCartItems(
                                      code: CartController.cartItems[index].id,
                                      all: false,
                                    ),
                                  );
