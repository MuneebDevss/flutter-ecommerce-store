...
import 'package:ecommerce_store/Core/Widgets/spaced_text.dart';
import 'package:ecommerce_store/Core/Controllers/product_controller.dart';
...
class _SportsState extends State<Sports> {
  CategoryController controller = Get.put(
    CategoryController(),
...
class HorizontalCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<WishBloc, WishesState>(
      builder: (BuildContext context, state) {
        return Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const BannerImage(image: ConstantImage.banner1),
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: List.generate(CategoryController.products.length, (
                  index,
                ) {
                  if (CategoryController.products[index].subCategory ==
                    ...
                    return Padding(
                      ...
                      child: SubCategoryCard(
                        isDark: isDark,
                        details: CategoryController.products[index],
                        index: index,
                ...
                Row(
                  children: [
                    Text(
                      ...
                      style: Theme.of(
                        context,
                      ).textTheme.labelLarge!.apply(color: TColors.grey),
                    ),
                    const SizedBox(width: Sizes.sm),
                    const Icon(
                      Iconsax.verify,
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      MyAddToCartButton(
                        ...
                        index: widget.index,
                        width:
                            widget.controller.index.contains(widget.index)
                                ? 70
                                : 40,
