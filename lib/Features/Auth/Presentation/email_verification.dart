...
import 'package:ecommerce_store/Features/Auth/Presentation/Controllers/email_verification_controller.dart';
import 'package:ecommerce_store/Features/Auth/Presentation/email_verified.dart';
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () => Get.offAll(() => const EmailVerified()),
                  child: Text(
                    'Continue',
                    style: Theme.of(
                      context,
