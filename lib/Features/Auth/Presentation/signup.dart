import 'package:ecommerce_store/Core/constants/text_constants.dart';
import 'package:ecommerce_store/Features/Auth/Presentation/AuthBloc/auth_bloc.dart';
import 'package:ecommerce_store/Features/Auth/Presentation/Controllers/sign_up_Controller.dart';
import 'package:ecommerce_store/Features/Auth/Presentation/email_verification.dart';
import 'package:ecommerce_store/Features/Widgets/input_field.dart';
import 'package:ecommerce_store/Features/Widgets/password_field.dart';
import 'package:ecommerce_store/Features/Widgets/section_divider.dart';
...
class _SignUpState extends State<SignUp> {
  final SignUpController myController = Get.put(
    SignUpController(),
              ...
              children: [
                ...
                SizedBox(
                  child: InputField(
                    ...
                    label: 'Username',
                    prefix: const Icon(Iconsax.user_edit, color: Colors.black),
                  ),
                ),
                const SizedBox(height: Sizes.spaceBtwItems),
                SizedBox(
