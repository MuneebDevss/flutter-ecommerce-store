...
import 'package:ecommerce_store/Features/Categories/Presentation/sports.dart';
        ...
        child: GestureDetector(
          child: Column(
            ...
            children: [
              ...
              // Body
              CarouselSliders(items: CategoriesItems.items),
              Obx(
                () => Row(
                    ...
                    for (int x = 0; x < 3; x++)
                      Padding(
                        ...
                        child: CircularContainer(
                          ...
                          color:
                              HomePageController.page.value == x
                                  ? Colors.green
                                  : Colors.grey,
                        ),
                      ),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () {
                        Get.to(
                          () => AllProducts(products: controller.products),
                        );
                      },
                      child: Text(
                        'View all',
              ...
              BlocConsumer<WishBloc, WishesState>(
                ...
                builder: (BuildContext context, WishesState state) {
                  if (state is SuccessState) {
                    return Padding(
                      padding: const EdgeInsets.symmetric(
                        horizontal: Sizes.md - 2,
                      ),
                      child: MyGridView(
                        itemBuilder:
                            (_, index) => ThumbnailCard(
