...
import 'package:ecommerce_store/Features/Navigation/Domain/Entities/wished.dart';
...
class _ThumbnailCardState extends State<ThumbnailCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        Get.to(
          () => ProductDetails(details: widget.details, wished: widget.wished),
        );
      },
      child: Container(
        ...
        child: Column(
          children: [
            CardImage(
              ...
              image: widget.details.imageUrl[0],
              off: widget.details.off,
