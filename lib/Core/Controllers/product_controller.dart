import 'package:ecommerce_store/Core/Entities/product.dart';
import 'package:ecommerce_store/Core/Entities/product.dart';
...
class CategoryController extends GetxController {
  ...
  static List<Product> products = [
    ...
    Product(
      ...
      sizes: ['9', '10', '11'],
      colors: ['brown', 'black', 'blueGrey'],
      title: 'Oxford Leather Shoes',
      brand: 'Clarks',
      price: 200,
      likes: 0,
      imageUrl: [
        'https://fhsofficial.com/cdn/shop/files/MSZ00375-010_13_1024x1024@2x.jpg?v=1703240246',
    ...
    Product(
      ...
      likes: 0,
      imageUrl: [
        'https://adoro.com.pk/cdn/shop/files/ClassicDerby-Black_8e475072-5715-434f-8157-d2bcd5b04e28.jpg?v=1688974131',
        'https://adoro.com.pk/cdn/shop/files/ClassicDerby-Black-1.jpg?v=1688974131',
        'https://adoro.com.pk/cdn/shop/products/62_764ed4d1-2bd9-4502-978d-ac105dc3b6a3.jpg?v=1688974131&width=1946',
      ],
      id: '5',
    ),
    Product(
      ...
      likes: 0,
      imageUrl: [
        'https://www.carminashoemaker.com/cdnassets/captoe_oxfords_tan_boxcalf_80386_l.jpg',
        'https://www.carminashoemaker.com/cdnassets/captoe_oxfords_tan_boxcalf_80386_sadl.jpg',
        'https://www.carminashoemaker.com/cdnassets/captoe_oxfords_tan_boxcalf_80386_fadl.jpg',
      ],
      id: '6',
    ),
